...
) ENGINE=InnoDB AUTO_INCREMENT=43623 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=35765 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
BEGIN
    ...
    DECLARE cur CURSOR FOR 
        SELECT invoice_id, owed, received 
        FROM invoice 
        WHERE customer_id = p_customer_id AND owed > 0
        ORDER BY date ASC; 
    ...
    read_loop: LOOP
        ...
        FETCH cur INTO v_invoice_id, v_owed, v_received;
        ...
        -- Update the invoice with new received amount
        UPDATE invoice
        SET received = v_received, owed = total_sales - v_received
...
-- Dump completed on 2025-02-05 12:21:00
